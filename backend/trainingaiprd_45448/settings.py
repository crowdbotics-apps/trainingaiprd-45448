"""
Django settings for trainingaiprd_45448 project.
...
ROOT_URLCONF = 'trainingaiprd_45448.urls'
...
WSGI_APPLICATION = 'trainingaiprd_45448.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trainingaiprd_45448 API",
    "DESCRIPTION": "API documentation for trainingaiprd_45448 App",
    "VERSION": "v1",
}
